...
/// </summary>
public sealed class LumenMediaApiFactory : WebApplicationFactory<Program>
{
    private readonly string _root = Path.Combine(Path.GetTempPath(), $"lumenmedia-it-{Guid.NewGuid():N}");

    private string DbPath => Path.Combine(_root, "lumenmedia.db");
