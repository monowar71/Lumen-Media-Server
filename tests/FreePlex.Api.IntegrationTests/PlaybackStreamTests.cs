...
/// </summary>
public class PlaybackStreamTests(FreePlexApiFactory factory) : IClassFixture<FreePlexApiFactory>
{
    private readonly FreePlexApiFactory _factory = factory;
    ...
    public async Task DirectPlay_Range_and_Transcode_Hls_seek_stop_work()
    {
        ...
        var mediaDir = Path.Combine(Path.GetTempPath(), $"freeplex-media-{Guid.NewGuid():N}");
