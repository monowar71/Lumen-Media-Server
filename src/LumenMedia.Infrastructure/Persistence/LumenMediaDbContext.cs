...
public sealed class LumenMediaDbContext(DbContextOptions<LumenMediaDbContext> options) : DbContext(options)
{
    ...
    {
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(LumenMediaDbContext).Assembly);
    }
}
