...
public sealed class MediaRepository(FreePlexDbContext db) : IMediaRepository
{
    ...
    private sealed class Row
    {
        ...
        public static System.Linq.Expressions.Expression<Func<MediaItem, Row>> Projection(FreePlexDbContext db, Guid userId) =>
            m => new Row
            {
                Id = m.Id,
                IsMovie = m is Movie,
